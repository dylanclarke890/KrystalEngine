...
namespace Krys::UI
{
  ...
  void Node::SetPosition(const Direction direction, const float ownerWidth, const float ownerHeight)
  {
    ...
    const FlexDirection mainAxis =
      Krys::UI::ResolveDirection(_style.GetFlexDirection(), directionRespectingRoot);
    const FlexDirection crossAxis = Krys::UI::ResolveCrossDirection(mainAxis, directionRespectingRoot);

...
{
  HTMLHRElement::HTMLHRElement(Document &document) noexcept : HTMLElement(document, HTMLElementInterface::HR)
  {
  }
...
#pragma region HTMLHRElement Obsolete members
  ...
  {
    return Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"color").value_or(u8"");
  }

  void HTMLHRElement::Color(dom::DOMString &&value) noexcept
  {
    Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"color", krys::move(value));
  }
  ...
  {
    return Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"size").value_or(u8"");
  }

  void HTMLHRElement::Size(dom::DOMString &&value) noexcept
  {
    Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"size", krys::move(value));
  }

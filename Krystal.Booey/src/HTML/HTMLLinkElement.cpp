...
#pragma region HTMLLinkElement
  ...
  dom::ExceptionOr<USVString> HTMLLinkElement::Href() const noexcept
  {
    return Attributes::Reflection::ReflectURL<USVString>(*this, u8"href");
  }

  dom::ExceptionOr<void> HTMLLinkElement::Href(USVString &&value) noexcept
  {
  ...
  {
    // TODO(HTMLLINKELEMENT, HTML): This is an enumerated attribute but I don't know the states/keywords.
    return Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"as").value_or(u8"");
  }

  void HTMLLinkElement::As(dom::DOMString &&value) noexcept
  {
    Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"as", krys::move(value));
  }
  ...
  {
    return Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"hreflang").value_or(u8"");
  }

  void HTMLLinkElement::HrefLang(dom::DOMString &&value) noexcept
  {
    Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"hreflang", krys::move(value));
  }
  ...
  dom::ExceptionOr<USVString> HTMLLinkElement::ImageSrcset() const noexcept
  {
    return Attributes::Reflection::Reflect<USVString>(*this, u8"imagesrcset");
  }

  dom::ExceptionOr<void> HTMLLinkElement::ImageSrcset(USVString &&value) noexcept
  {
  ...
  {
    return Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"imagesizes").value_or(u8"");
  }

  void HTMLLinkElement::ImageSizes(dom::DOMString &&value) noexcept
  {
    Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"imagesizes", krys::move(value));
  }

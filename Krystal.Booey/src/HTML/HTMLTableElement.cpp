...
#pragma region HTMLTableElement Obsolete members
  ...
  {
    return Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"frame").value_or(u8"");
  }

  void HTMLTableElement::Frame(dom::DOMString &&value) noexcept
  {
    Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"frame", krys::move(value));
  }

  dom::DOMString HTMLTableElement::Rules() const noexcept
  {
    return Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"rules").value_or(u8"");
  }

  void HTMLTableElement::Rules(dom::DOMString &&value) noexcept
  {
    Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"rules", krys::move(value));
  }

  dom::DOMString HTMLTableElement::Summary() const noexcept
  {
    return Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"summary").value_or(u8"");
  }

  void HTMLTableElement::Summary(dom::DOMString &&value) noexcept
  {
    Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"summary", krys::move(value));
  }
  ...
  {
    return Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"cellpadding").value_or(u8"");
  }

  void HTMLTableElement::CellPadding(dom::DOMString &&value) noexcept
  {
    Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"cellpadding", krys::move(value));
  }

  dom::DOMString HTMLTableElement::CellSpacing() const noexcept
  {
    return Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"cellspacing").value_or(u8"");
  }

  void HTMLTableElement::CellSpacing(dom::DOMString &&value) noexcept
  {
    Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"cellspacing", krys::move(value));
  }

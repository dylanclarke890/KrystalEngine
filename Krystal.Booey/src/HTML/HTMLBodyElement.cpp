...
{
  HTMLBodyElement::HTMLBodyElement(Document &document) noexcept : HTMLElement(document, HTMLElementInterface::Body)
  {
  }
...
#pragma region HTMLBodyElement Obsolete members
  ...
  {
    return Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"link").value_or(u8"");
  }

  void HTMLBodyElement::Link(dom::DOMString &&value) noexcept
  {
    Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"link", krys::move(value));
  }

  dom::DOMString HTMLBodyElement::VLink() const noexcept
  {
    return Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"vlink").value_or(u8"");
  }

  void HTMLBodyElement::VLink(dom::DOMString &&value) noexcept
  {
    Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"vlink", krys::move(value));
  }

  dom::DOMString HTMLBodyElement::ALink() const noexcept
  {
    return Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"alink").value_or(u8"");
  }

  void HTMLBodyElement::ALink(dom::DOMString &&value) noexcept
  {
    Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"alink", krys::move(value));
  }
  ...
  {
    return Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"background").value_or(u8"");
  }

  void HTMLBodyElement::Background(dom::DOMString &&value) noexcept
  {
    Attributes::Reflection::Reflect<dom::DOMString>(*this, u8"background", krys::move(value));
  }

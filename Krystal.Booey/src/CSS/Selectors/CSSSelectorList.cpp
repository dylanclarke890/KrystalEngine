...
#pragma endregion
  ...
  {
    return ForEachSelector([](const CSSSelector *selector) noexcept -> bool
...
#pragma region Static utility functions
  ...
  CSSSelectorList CSSSelectorList::Join(const SmallList<const CSSSelectorList *> &lists) noexcept
  {

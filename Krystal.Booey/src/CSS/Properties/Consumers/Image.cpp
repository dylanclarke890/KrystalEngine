...
namespace krys::boo::css::PropertyParserHelpers
{
    ...
    ConsumeDeprecatedGradientPosition(TokenRange &tokens, PropertyParserState &state) noexcept
  {
    ...
    auto vertical = ConsumeDeprecatedGradientPositionComponent<ValueId::Top, ValueId::Bottom>(tokens, state);
    if (!vertical)
    {
      return null;
    }
  ...
  KRYS_NODISCARD static Maybe<Color> ConsumeDeprecatedGradientStopColor(TokenRange &tokens,
  ...
  KRYS_NODISCARD static RefPtr<Value> ConsumeDeprecatedLinearGradient(TokenRange &tokens,
                                                                      PropertyParserState &state) noexcept
  {
  ...
  KRYS_NODISCARD static RefPtr<Value> ConsumeDeprecatedRadialGradient(TokenRange &tokens,
                                                                      PropertyParserState &state) noexcept
  {
    if (!ConsumeComma(tokens))
    {
  ...
  KRYS_NODISCARD static Maybe<Color> ConsumeStopColor(TokenRange &tokens, PropertyParserState &state) noexcept
  {
    return ConsumeUnresolvedColor(tokens, state);
  }
                                                                       ...
                                                                       PropertyParserState &state)
  {
    ...
    KRYS_NODISCARD constexpr static auto verticalMappings = std::to_array<std::pair<ValueId, CSS::Vertical>>({
    ...
    auto consumeKeywordGradientLineKnownHorizontal =
      [&](TokenRange &tokens, CSS::Horizontal knownHorizontal) -> CSS::PrefixedLinearGradient::GradientLine
    {
    ...
    auto consumeKeywordGradientLineKnownVertical =
      [&](TokenRange &tokens, CSS::Vertical knownVertical) -> CSS::PrefixedLinearGradient::GradientLine
    {
    ...
    auto consumeKeywordGradientLine =
      [&](TokenRange &tokens) -> Maybe<CSS::PrefixedLinearGradient::GradientLine>
    {
  ...
  KRYS_NODISCARD static RefPtr<CSSValue> consumeLinearGradient(TokenRange &tokens, PropertyParserState &state)
  {
    ...
    auto consumeKeywordGradientLineKnownHorizontal =
      [&](TokenRange &tokens, CSS::Horizontal knownHorizontal) -> CSS::LinearGradient::GradientLine
    {
      if (auto vertical = consumeIdentUsingMapping(tokens, verticalMap))
        return SpaceSeparatedTuple {knownHorizontal, *vertical};
      return knownHorizontal;
    ...
    auto consumeKeywordGradientLineKnownVertical =
      [&](TokenRange &tokens, CSS::Vertical knownVertical) -> CSS::LinearGradient::GradientLine
    {
      if (auto horizontal = consumeIdentUsingMapping(tokens, horizontalMap))
        return SpaceSeparatedTuple {*horizontal, knownVertical};
      return knownVertical;
    ...
    auto consumeKeywordGradientLine = [&](TokenRange &tokens) -> Maybe<CSS::LinearGradient::GradientLine>
    {
  ...
  KRYS_NODISCARD static RefPtr<Value> consumeCrossFade(TokenRange &args, PropertyParserState &state,
                                                       ValueId FunctionId) noexcept
  {

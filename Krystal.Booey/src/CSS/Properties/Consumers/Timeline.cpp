...
namespace krys::boo::css::CSSPropertyParserHelpers
{
  ...
  RefPtr<CSSValue> ConsumeAnimationTimelineScroll(TokenRange &tokens, CSSPropertyParserState &state) noexcept
  {
    ...
    if (tokens.Peek().Type() != TokenType::Function || tokens.Peek().FunctionId() != CSSValueId::Scroll)
    {
      return nullptr;
    }
  ...
  RefPtr<CSSValue> ConsumeAnimationTimelineView(TokenRange &tokens, CSSPropertyParserState &state) noexcept
  {
    ...
    if (tokens.Peek().Type() != TokenType::Function || tokens.Peek().FunctionId() != CSSValueId::View)
    {
      return nullptr;
    }
  ...
  RefPtr<CSSValue> ConsumeSingleAnimationRange(TokenRange &tokens, CSSPropertyParserState &state,
  ...
  RefPtr<CSSValue> ConsumeSingleAnimationRangeEnd(TokenRange &tokens, CSSPropertyParserState &state) noexcept
  {

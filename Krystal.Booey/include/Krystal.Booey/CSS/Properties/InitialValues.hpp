...
namespace krys::boo::css
{
  ...
  KRYS_NODISCARD constexpr static InitialValue InitialValueForLonghand(PropertyId longhand) noexcept
  {
    switch (longhand)
    {
      ...
      {
        return InitialNumericValue {0, UnitType::Number};
      }
      ...
      {
        return InitialNumericValue {1, UnitType::Number};
      }
      ...
      {
        return InitialNumericValue {0, UnitType::s};
      }
      ...
      {
        return InitialNumericValue {0, UnitType::Percentage};
      }
      ...
      {
        return InitialNumericValue {100, UnitType::Percentage};
      }
      ...
      case PropertyId::Y:
      {
        return InitialNumericValue {0, UnitType::px};
      }
      ...
      {
        return InitialNumericValue {0, UnitType::deg};
      }
      ...
      {
        return InitialNumericValue {50, UnitType::Percentage};
      }
      ...
      {
        return InitialNumericValue {4, UnitType::Number};
      }
      case PropertyId::StrokeWidth:
      {
        return InitialNumericValue {1, UnitType::px};
      }
      case PropertyId::TabSize:
      {
        return InitialNumericValue {8, UnitType::Number};
      }

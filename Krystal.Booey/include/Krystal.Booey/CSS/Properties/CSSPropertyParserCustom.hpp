...
#include "Krystal.Booey/CSS/Properties/CSSFontVariantLigaturesParser.hpp"
#include "Krystal.Booey/CSS/Properties/CSSFontVariantNumericParser.hpp"
...
#include "Krystal.Booey/CSS/Properties/CSSPropertyShorthandFunctions.hpp"
...
namespace krys::boo::css
{
  ...
  KRYS_NODISCARD inline Maybe<BorderShorthandComponents>
    ConsumeBorderShorthandComponents(TokenRange &tokens, CSSPropertyParserState &state) noexcept
  {
  ...
  public:
    KRYS_NODISCARD static bool
      ConsumeStandardSpaceSeparatedShorthand(TokenRange &tokens, CSSPropertyParserState &state,
    ...
    KRYS_NODISCARD static bool ConsumeCoalescingPairShorthand(TokenRange &tokens,
    ...
    KRYS_NODISCARD static bool ConsumeCoalescingQuadShorthand(TokenRange &tokens,
                                                              CSSPropertyParserState &state,
                                                              const CSSPropertyShorthand &shorthand,
                                                              CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeBorderShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                      const CSSPropertyShorthand &shorthand,
                                                      CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeBorderInlineShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                            const CSSPropertyShorthand &shorthand,
                                                            CSSPropertyParserResult &result) noexcept
    {
      auto components = ConsumeBorderShorthandComponents(tokens, state);
    ...
    KRYS_NODISCARD static bool ConsumeBorderImageShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                           const CSSPropertyShorthand &shorthand,
                                                           CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeBorderBlockShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                           const CSSPropertyShorthand &shorthand,
                                                           CSSPropertyParserResult &result) noexcept
    {
      auto components = ConsumeBorderShorthandComponents(tokens, state);
    ...
    KRYS_NODISCARD static bool ConsumeBorderRadiusShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                            const CSSPropertyShorthand &shorthand,
                                                            CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeBorderSpacingShorthand(TokenRange &tokens,
                                                             CSSPropertyParserState &state,
    ...
    KRYS_NODISCARD static bool ConsumeAnimationShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                         const CSSPropertyShorthand &shorthand,
                                                         CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeTransitionShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                          const CSSPropertyShorthand &shorthand,
                                                          CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeBackgroundShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                          const CSSPropertyShorthand &shorthand,
                                                          CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeMaskShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                    const CSSPropertyShorthand &shorthand,
                                                    CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeMaskPositionShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                            const CSSPropertyShorthand &shorthand,
                                                            CSSPropertyParserResult &result) noexcept
    {
      CSSValueListBuilder x;
    ...
    KRYS_NODISCARD static bool ConsumeOverflowShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                        const CSSPropertyShorthand &shorthand,
                                                        CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeColumnsShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                       const CSSPropertyShorthand &shorthand,
                                                       CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeGridTemplateShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                            const CSSPropertyShorthand &shorthand,
                                                            CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeGridShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                    const CSSPropertyShorthand &shorthand,
                                                    CSSPropertyParserResult &result) noexcept
    {
      assert(shorthand.Size() == 6);

      auto ConsumeImplicitGridAutoFlow = [](TokenRange &tokens, CSSValueId flowDirection) -> RefPtr<CSSValue>
      {
        // [ auto-flow && dense? ]
    ...
    KRYS_NODISCARD static bool ConsumeGridAreaShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                        const CSSPropertyShorthand &shorthand,
                                                        CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeAlignShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                     const CSSPropertyShorthand &shorthand,
                                                     CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeBlockStepShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                         const CSSPropertyShorthand &shorthand,
                                                         CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeFontShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                    const CSSPropertyShorthand &shorthand,
                                                    CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeFontVariantShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                           const CSSPropertyShorthand &shorthand,
                                                           CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeFontSynthesisShorthand(TokenRange &tokens,
                                                             CSSPropertyParserState &state,
                                                             const CSSPropertyShorthand &shorthand,
                                                             CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeMaskBorderShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                          const CSSPropertyShorthand &shorthand,
                                                          CSSPropertyParserResult &result) noexcept
    {
      auto components = ConsumeBorderImageComponents(tokens, state);
    ...
    KRYS_NODISCARD static bool ConsumeFlexShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                    const CSSPropertyShorthand &shorthand,
                                                    CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumePageBreakAfterShorthand(TokenRange &tokens,
                                                              CSSPropertyParserState &state,
                                                              const CSSPropertyShorthand &shorthand,
                                                              CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumePageBreakBeforeShorthand(TokenRange &tokens,
                                                               CSSPropertyParserState &state,
                                                               const CSSPropertyShorthand &shorthand,
                                                               CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumePageBreakInsideShorthand(TokenRange &tokens,
                                                               CSSPropertyParserState &state,
                                                               const CSSPropertyShorthand &shorthand,
                                                               CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeTransformOriginShorthand(TokenRange &tokens,
                                                               CSSPropertyParserState &state,
                                                               const CSSPropertyShorthand &shorthand,
                                                               CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeOffsetShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                      const CSSPropertyShorthand &shorthand,
                                                      CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeListStyleShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                         const CSSPropertyShorthand &shorthand,
                                                         CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeContainerShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                         const CSSPropertyShorthand &shorthand,
                                                         CSSPropertyParserResult &result) noexcept
    {
      RefPtr name =
    ...
    KRYS_NODISCARD static bool ConsumeAnimationRangeShorthand(TokenRange &tokens,
                                                              CSSPropertyParserState &state,
                                                              const CSSPropertyShorthand &shorthand,
                                                              CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeScrollTimelineShorthand(TokenRange &tokens,
                                                              CSSPropertyParserState &state,
                                                              const CSSPropertyShorthand &shorthand,
                                                              CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeViewTimelineShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                            const CSSPropertyShorthand &shorthand,
                                                            CSSPropertyParserResult &result) noexcept
    {
      CSSValueListBuilder namesList;
    ...
    KRYS_NODISCARD static bool ConsumeLineClampShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                         const CSSPropertyShorthand &shorthand,
                                                         CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeTextBoxShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                       const CSSPropertyShorthand &shorthand,
                                                       CSSPropertyParserResult &result) noexcept
    {
      if (tokens.Peek().ValueId() == CSSValueId::Normal)
    ...
    KRYS_NODISCARD static bool ConsumeTextWrapShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                        const CSSPropertyShorthand &shorthand,
                                                        CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumeWhiteSpaceShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                          const CSSPropertyShorthand &shorthand,
                                                          CSSPropertyParserResult &result) noexcept
    {
    ...
    KRYS_NODISCARD static bool ConsumePositionTryShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                           const CSSPropertyShorthand &shorthand,
                                                           CSSPropertyParserResult &result) noexcept
    {
      auto order =
    ...
    KRYS_NODISCARD static bool ConsumeMarkerShorthand(TokenRange &tokens, CSSPropertyParserState &state,
                                                      const CSSPropertyShorthand &shorthand,
                                                      CSSPropertyParserResult &result) noexcept
    {

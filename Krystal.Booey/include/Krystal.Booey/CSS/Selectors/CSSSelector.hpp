...
#include "Krystal.Booey/CSS/Selectors/Enums/CSSSelectorFlag.hpp"
...
namespace krys::boo::css
{
  ...
  public:
    ...
    explicit CSSSelector(const dom::QualifiedName &name, bool tagIsForNamespaceRule = false) noexcept;
    ...
    KRYS_NODISCARD const CSSSelectorList *SubSelectors() const noexcept
    {
...
#pragma region Traversal
    ...
    KRYS_NODISCARD const CSSSelector *PrecedingComplexSelectorComponent() const noexcept
    {
    ...
    KRYS_NODISCARD const CSSSelector *PrecedingCompoundSelectorComponent() const noexcept
    {
    ...
    KRYS_NODISCARD const CSSSelector *FirstInCompoundSelector() const noexcept
    {
      auto *selector = this;
    ...
    KRYS_NODISCARD const CSSSelector *LastInCompoundSelector() const noexcept
    {
      auto *selector = this;

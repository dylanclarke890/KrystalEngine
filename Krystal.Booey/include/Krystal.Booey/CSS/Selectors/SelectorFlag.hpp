...
namespace krys::boo::css
{
  enum class SelectorFlag : uint8
  {
    ...
    HasRareData = 1 << 4,
    /// @brief Set when the type selector is for a namespace rule (e.g. `@namespace svg
...
KRYS_DEFINE_FLAGS_ENUM_TRAITS(krys::boo::css::SelectorFlag, 8uz);
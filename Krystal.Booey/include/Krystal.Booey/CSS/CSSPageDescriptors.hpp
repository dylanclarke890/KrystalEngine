...
namespace krys::boo::css
{
  ...
  class CSSPageDescriptors final : public CSSStyleDeclaration
  {
  public:
#pragma region CSSPageDescriptors - https://drafts.csswg.org/cssom/#csspagedescriptors

    // TODO(CSSPageDescriptors): Implement the CSSPageDescriptors interface.

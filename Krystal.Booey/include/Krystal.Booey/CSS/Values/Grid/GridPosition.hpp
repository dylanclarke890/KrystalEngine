...
DEFINE_VARIANT_LIKE_CONFORMANCE(krys::boo::css::GridPosition)
DEFINE_VARIANT_LIKE_CONFORMANCE(krys::boo::css::GridPosition::Explicit)
DEFINE_VARIANT_LIKE_CONFORMANCE(krys::boo::css::GridPosition::Span)
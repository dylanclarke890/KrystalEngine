...
KRYS_DEFINE_CONTIGUOUS_ENUM_TRAITS(krys::boo::html::TagName, 164u);

namespace krys::boo::html
{
  KRYS_NODISCARD constexpr TagName ParseTagName(dom::DOMStringView name) noexcept
  {
    krys_debug_assert(!name.empty());

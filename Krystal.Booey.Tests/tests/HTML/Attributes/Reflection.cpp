...
namespace krys::boo::html::tests
{
  namespace
  {
    ...
    dom::DOMStringAtom TestAttribute = u8"test-attr";
  ...
  TEST_CASE("Reflection::Reflect", "[Attributes]")
  {
    SECTION("[Reflect]")
    {
      SECTION("DOMString")
      {
        ...
        REQUIRE(Reflection::Reflect<dom::DOMString>(*data.Element, TestAttribute) == u8"initial value");

        Reflection::Reflect<dom::DOMString>(*data.Element, TestAttribute, u8"new value");
        REQUIRE(Reflection::Reflect<dom::DOMString>(*data.Element, TestAttribute) == u8"new value");
      }

      SECTION("Maybe<dom::DOMString>")
      {
        TestData data;
        REQUIRE(Reflection::Reflect<Maybe<dom::DOMString>>(*data.Element, TestAttribute) == null);

        Reflection::Reflect<Maybe<dom::DOMString>>(*data.Element, TestAttribute, u8"new value");
        REQUIRE(Reflection::Reflect<Maybe<dom::DOMString>>(*data.Element, TestAttribute) == u8"new value");

        Reflection::Reflect<Maybe<dom::DOMString>>(*data.Element, TestAttribute, null);
        REQUIRE(Reflection::Reflect<Maybe<dom::DOMString>>(*data.Element, TestAttribute) == null);
      }
  ...
  TEST_CASE("Reflection::ReflectSetter", "[Attributes]")
  {
    ...
    {
      TestData data;
      Reflection::ReflectSetter<dom::DOMString>(*data.Element, TestAttribute, u8"setter value");
      REQUIRE(Reflection::Reflect<dom::DOMString>(*data.Element, TestAttribute) == u8"setter value");
    }

...
namespace Krys::HTML
{
  ...
  // Skipping CSSPropertyId::ObjectPosition, initial is a list with multiple values [NumericLiteral 50%, NumericLiteral 50%]
  // Skipping CSSPropertyId::TextEmphasisPosition, initial is a list with multiple values [over, right]
  // Skipping CSSPropertyId::WebkitLineBoxContain, initial is a list with multiple values [block, inline, replaced]

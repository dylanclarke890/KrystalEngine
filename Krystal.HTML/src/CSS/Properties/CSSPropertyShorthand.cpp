...
namespace Krys::HTML
{
  ...
  CSSPropertyShorthand TransitionShorthandForParsing() noexcept
  {
    // Similar to animations, we have property after timing-function and delay after
    // duration.
    constexpr static Array transitionProperties = {
    ...
    return CSSPropertyShorthand(CSSPropertyId::Transition, Span {transitionProperties});
  }

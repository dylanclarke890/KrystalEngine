...
namespace Krys::UI::Layout
{
  ...
  Styles::Direction NodeLayoutGetDirection(NodeConstRef node);
  ...
  float NodeLayoutGetMargin(NodeConstRef node, Styles::Edge edge);

  float NodeLayoutGetBorder(NodeConstRef node, Styles::Edge edge);

  float NodeLayoutGetPadding(NodeConstRef node, Styles::Edge edge);

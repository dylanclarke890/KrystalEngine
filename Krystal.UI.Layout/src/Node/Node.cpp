...
namespace Krys::UI::Layout
{
  ...
  void Node::SetPosition(const Direction direction, const float ownerWidth, const float ownerHeight)
  {
    ...
    const FlexDirection mainAxis =
      UI::Layout::ResolveDirection(_style.GetFlexDirection(), directionRespectingRoot);
    const FlexDirection crossAxis = UI::Layout::ResolveCrossDirection(mainAxis, directionRespectingRoot);

...
namespace
{
  ...
  {
    using namespace krys::pal::win32;
  ...
  static krys::pal::Key KeyCodeToEngineKey(const WPARAM keyCode) noexcept
  {
    using krys::pal::Key;
    switch (keyCode)
    {
...
namespace krys::pal
{
  ...
  namespace win32
  {
    ...
    {
      static HashSet<WPARAM> _pressedKeys;

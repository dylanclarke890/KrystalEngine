...
namespace Krys
{
  ...
  private:
    KRYS_NODISCARD static EncodingInfo GetEncodingInfo() noexcept
    {
      static EncodingInfo info {
        .Name = u8"ISO-8859-10",
        .Aliases = {u8"iso-8859-10", u8"csisolatin6", u8"iso-ir-157", u8"iso8859-10", u8"iso885910",
                    u8"iso_8859-10", u8"iso_8859-10:1992", u8"l6", u8"latin6"},
        .MIBenum = MIBenum {13u},
        .Win32CodePage = Win32CodePage {28'600u},
  ...
  public:
    static constexpr Mapping LookupMapping = {
      ...
      MapItem {0xA2u, Rune(0x0112u)}, //	LATIN CAPITAL LETTER E WITH MACRON
      MapItem {0xA3u, Rune(0x0122u)}, //	LATIN CAPITAL LETTER G WITH CEDILLA
      MapItem {0xA4u, Rune(0x012Au)}, //	LATIN CAPITAL LETTER I WITH MACRON
      MapItem {0xA5u, Rune(0x0128u)}, //	LATIN CAPITAL LETTER I WITH TILDE
      MapItem {0xA6u, Rune(0x0136u)}, //	LATIN CAPITAL LETTER K WITH CEDILLA
      MapItem {0xA7u, Rune(0x00A7u)}, //	SECTION SIGN
      MapItem {0xA8u, Rune(0x013Bu)}, //	LATIN CAPITAL LETTER L WITH CEDILLA
      MapItem {0xA9u, Rune(0x0110u)}, //	LATIN CAPITAL LETTER D WITH STROKE
      MapItem {0xAAu, Rune(0x0160u)}, //	LATIN CAPITAL LETTER S WITH CARON
      MapItem {0xABu, Rune(0x0166u)}, //	LATIN CAPITAL LETTER T WITH STROKE
      MapItem {0xACu, Rune(0x017Du)}, //	LATIN CAPITAL LETTER Z WITH CARON
      MapItem {0xADu, Rune(0x00ADu)}, //	SOFT HYPHEN
      MapItem {0xAEu, Rune(0x016Au)}, //	LATIN CAPITAL LETTER U WITH MACRON
      MapItem {0xAFu, Rune(0x014Au)}, //	LATIN CAPITAL LETTER ENG
      MapItem {0xB0u, Rune(0x00B0u)}, //	DEGREE SIGN
      MapItem {0xB1u, Rune(0x0105u)}, //	LATIN SMALL LETTER A WITH OGONEK
      MapItem {0xB2u, Rune(0x0113u)}, //	LATIN SMALL LETTER E WITH MACRON
      MapItem {0xB3u, Rune(0x0123u)}, //	LATIN SMALL LETTER G WITH CEDILLA
      MapItem {0xB4u, Rune(0x012Bu)}, //	LATIN SMALL LETTER I WITH MACRON
      MapItem {0xB5u, Rune(0x0129u)}, //	LATIN SMALL LETTER I WITH TILDE
      MapItem {0xB6u, Rune(0x0137u)}, //	LATIN SMALL LETTER K WITH CEDILLA
      MapItem {0xB7u, Rune(0x00B7u)}, //	MIDDLE DOT
      MapItem {0xB8u, Rune(0x013Cu)}, //	LATIN SMALL LETTER L WITH CEDILLA
      MapItem {0xB9u, Rune(0x0111u)}, //	LATIN SMALL LETTER D WITH STROKE
      MapItem {0xBAu, Rune(0x0161u)}, //	LATIN SMALL LETTER S WITH CARON
      MapItem {0xBBu, Rune(0x0167u)}, //	LATIN SMALL LETTER T WITH STROKE
      MapItem {0xBCu, Rune(0x017Eu)}, //	LATIN SMALL LETTER Z WITH CARON
      MapItem {0xBDu, Rune(0x2015u)}, //	HORIZONTAL BAR
      MapItem {0xBEu, Rune(0x016Bu)}, //	LATIN SMALL LETTER U WITH MACRON
      MapItem {0xBFu, Rune(0x014Bu)}, //	LATIN SMALL LETTER ENG
      MapItem {0xC0u, Rune(0x0100u)}, //	LATIN CAPITAL LETTER A WITH MACRON
      ...
      MapItem {0xC3u, Rune(0x00C3u)}, //	LATIN CAPITAL LETTER A WITH TILDE
      ...
      MapItem {0xC7u, Rune(0x012Eu)}, //	LATIN CAPITAL LETTER I WITH OGONEK
      ...
      MapItem {0xCCu, Rune(0x0116u)}, //	LATIN CAPITAL LETTER E WITH DOT ABOVE
      ...
      MapItem {0xD0u, Rune(0x00D0u)}, //	LATIN CAPITAL LETTER ETH (Icelandic)
      MapItem {0xD1u, Rune(0x0145u)}, //	LATIN CAPITAL LETTER N WITH CEDILLA
      MapItem {0xD2u, Rune(0x014Cu)}, //	LATIN CAPITAL LETTER O WITH MACRON
      ...
      MapItem {0xD7u, Rune(0x0168u)}, //	LATIN CAPITAL LETTER U WITH TILDE
      MapItem {0xD8u, Rune(0x00D8u)}, //	LATIN CAPITAL LETTER O WITH STROKE
      MapItem {0xD9u, Rune(0x0172u)}, //	LATIN CAPITAL LETTER U WITH OGONEK
      ...
      MapItem {0xDEu, Rune(0x00DEu)}, //	LATIN CAPITAL LETTER THORN (Icelandic)
      MapItem {0xDFu, Rune(0x00DFu)}, //	LATIN SMALL LETTER SHARP S (German)
      MapItem {0xE0u, Rune(0x0101u)}, //	LATIN SMALL LETTER A WITH MACRON
      ...
      MapItem {0xE3u, Rune(0x00E3u)}, //	LATIN SMALL LETTER A WITH TILDE
      ...
      MapItem {0xE7u, Rune(0x012Fu)}, //	LATIN SMALL LETTER I WITH OGONEK
      ...
      MapItem {0xECu, Rune(0x0117u)}, //	LATIN SMALL LETTER E WITH DOT ABOVE
      ...
      MapItem {0xF0u, Rune(0x00F0u)}, //	LATIN SMALL LETTER ETH (Icelandic)
      MapItem {0xF1u, Rune(0x0146u)}, //	LATIN SMALL LETTER N WITH CEDILLA
      MapItem {0xF2u, Rune(0x014Du)}, //	LATIN SMALL LETTER O WITH MACRON
      ...
      MapItem {0xF7u, Rune(0x0169u)}, //	LATIN SMALL LETTER U WITH TILDE
      MapItem {0xF8u, Rune(0x00F8u)}, //	LATIN SMALL LETTER O WITH STROKE
      MapItem {0xF9u, Rune(0x0173u)}, //	LATIN SMALL LETTER U WITH OGONEK
      ...
      MapItem {0xFEu, Rune(0x00FEu)}, //	LATIN SMALL LETTER THORN (Icelandic)
      MapItem {0xFFu, Rune(0x0138u)}, //	LATIN SMALL LETTER KRA
    };

  public:
    ISO_8859_10_Encoding() noexcept : SingleByteEncoding(GetEncodingInfo(), LookupTable(LookupMapping))
    {
    }

...
namespace Krys
{
  class ISO_8859_9_Encoding : public SingleByteEncoding
  {
  private:
    KRYS_NODISCARD static EncodingInfo GetEncodingInfo() noexcept
    {
      static EncodingInfo info {
        .Name = u8"ISO-8859-9",
        .Aliases = {u8"iso-8859-9"},
        .MIBenum = MIBenum {12u},
        .Win32CodePage = Win32CodePage {28'599u},
  ...
  public:
    ISO_8859_9_Encoding() noexcept : SingleByteEncoding(GetEncodingInfo(), LookupTable(LookupMapping))
    {
    }

    ~ISO_8859_9_Encoding() noexcept override = default;
  };
}
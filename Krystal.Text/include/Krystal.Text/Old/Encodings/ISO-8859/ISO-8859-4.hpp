...
namespace Krys
{
  class ISO_8859_4_Encoding : public SingleByteEncoding
  {
  private:
    KRYS_NODISCARD static EncodingInfo GetEncodingInfo() noexcept
    {
      static EncodingInfo info {
        .Name = u8"ISO-8859-4",
        .Aliases = {u8"csisolatin4", u8"iso-ir-110", u8"iso8859-4", u8"iso88594", u8"iso_8859-4",
                    u8"iso_8859-4:1988", u8"l4", u8"latin4", u8"iso-8859-4"},
        .MIBenum = MIBenum {7u},
        .Win32CodePage = Win32CodePage {28'594u},
  ...
  public:
    static constexpr Mapping LookupMapping = {
      ...
      MapItem {0xA2u, Rune(0x0138u)}, //	LATIN SMALL LETTER KRA
      MapItem {0xA3u, Rune(0x0156u)}, //	LATIN CAPITAL LETTER R WITH CEDILLA
      MapItem {0xA4u, Rune(0x00A4u)}, //	CURRENCY SIGN
      MapItem {0xA5u, Rune(0x0128u)}, //	LATIN CAPITAL LETTER I WITH TILDE
      MapItem {0xA6u, Rune(0x013Bu)}, //	LATIN CAPITAL LETTER L WITH CEDILLA
      ...
      MapItem {0xAAu, Rune(0x0112u)}, //	LATIN CAPITAL LETTER E WITH MACRON
      MapItem {0xABu, Rune(0x0122u)}, //	LATIN CAPITAL LETTER G WITH CEDILLA
      MapItem {0xACu, Rune(0x0166u)}, //	LATIN CAPITAL LETTER T WITH STROKE
      ...
      MapItem {0xB3u, Rune(0x0157u)}, //	LATIN SMALL LETTER R WITH CEDILLA
      MapItem {0xB4u, Rune(0x00B4u)}, //	ACUTE ACCENT
      MapItem {0xB5u, Rune(0x0129u)}, //	LATIN SMALL LETTER I WITH TILDE
      MapItem {0xB6u, Rune(0x013Cu)}, //	LATIN SMALL LETTER L WITH CEDILLA
      ...
      MapItem {0xBAu, Rune(0x0113u)}, //	LATIN SMALL LETTER E WITH MACRON
      MapItem {0xBBu, Rune(0x0123u)}, //	LATIN SMALL LETTER G WITH CEDILLA
      MapItem {0xBCu, Rune(0x0167u)}, //	LATIN SMALL LETTER T WITH STROKE
      MapItem {0xBDu, Rune(0x014Au)}, //	LATIN CAPITAL LETTER ENG
      ...
      MapItem {0xCFu, Rune(0x012Au)}, //	LATIN CAPITAL LETTER I WITH MACRON
      ...
      MapItem {0xD3u, Rune(0x0136u)}, //	LATIN CAPITAL LETTER K WITH CEDILLA
      ...
      MapItem {0xDDu, Rune(0x0168u)}, //	LATIN CAPITAL LETTER U WITH TILDE
      MapItem {0xDEu, Rune(0x016Au)}, //	LATIN CAPITAL LETTER U WITH MACRON
      ...
      MapItem {0xEFu, Rune(0x012Bu)}, //	LATIN SMALL LETTER I WITH MACRON
      ...
      MapItem {0xF3u, Rune(0x0137u)}, //	LATIN SMALL LETTER K WITH CEDILLA
      ...
      MapItem {0xFDu, Rune(0x0169u)}, //	LATIN SMALL LETTER U WITH TILDE
      MapItem {0xFEu, Rune(0x016Bu)}, //	LATIN SMALL LETTER U WITH MACRON
      MapItem {0xFFu, Rune(0x02D9u)}, //	DOT ABOVE
    };

  public:
    ISO_8859_4_Encoding() noexcept : SingleByteEncoding(GetEncodingInfo(), LookupTable(LookupMapping))
    {
    }

    ~ISO_8859_4_Encoding() noexcept override = default;
  };
}
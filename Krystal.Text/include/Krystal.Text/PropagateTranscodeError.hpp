...
namespace Krys
{
  ...
  {
    using TResult =
      TranscodeResult<TResultInput, remove_cvref_t<TOutput>, TFromState, TToState, TResultIntermediate>;
    return Krys::PropagateTranscodeDecodeError<TResult>(
    ...
    TToOutputProgress &&toOutputProgress) noexcept
  {
    ...
    return Krys::PropagateTranscodeEncodeError<TResult>(

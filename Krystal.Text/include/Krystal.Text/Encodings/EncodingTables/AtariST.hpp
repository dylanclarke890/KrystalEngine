...
{
#pragma region Table
  constexpr inline const index32_code_point AtariSTIndexCodePointMap[256] = {
    {0, 0x0000},
    {1, 0x21E7},
    {2, 0x21E9},
    {3, 0x21E8},
...
#pragma endregion
  ...
  KRYS_NODISCARD constexpr inline std::optional<std::uint_least32_t>
    atari_st_index_to_code_point(std::size_t lookupIndexPointer) noexcept
  {
  ...
  KRYS_NODISCARD constexpr inline std::optional<std::size_t>
    atari_st_code_point_to_index(std::uint_least32_t lookupCodePoint) noexcept
  {

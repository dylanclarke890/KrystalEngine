...
{
#pragma region Table
  constexpr inline const index16_code_point ISO_8859_2_IndexCodePointMap[128] = {
...
#pragma endregion
  ...
  KRYS_NODISCARD constexpr Maybe<uint32> ISO_8859_2IndexToCodePoint(size_t lookupIndexPointer) noexcept
  {
    auto lookupIndex = static_cast<const index16>(lookupIndexPointer);
    auto begin = std::ranges::cend(ISO_8859_2_IndexCodePointMap);
    auto end = std::ranges::cend(ISO_8859_2_IndexCodePointMap);
  ...
  KRYS_NODISCARD constexpr Maybe<size_t> ISO_8859_2CodePointToIndex(uint32 lookupCodePoint) noexcept
  {
    auto begin = std::ranges::cend(ISO_8859_2_IndexCodePointMap);
    auto end = std::ranges::cend(ISO_8859_2_IndexCodePointMap);

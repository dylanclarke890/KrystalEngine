...
#pragma endregion
  ...
  KRYS_NODISCARD constexpr inline std::optional<std::uint_least32_t>
    ibm_866_cyrillic_index_to_code_point(std::size_t lookupIndexPointer) noexcept
  {
  ...
  KRYS_NODISCARD constexpr inline std::optional<std::size_t>
    ibm_866_cyrillic_code_point_to_index(std::uint_least32_t lookupCodePoint) noexcept
  {

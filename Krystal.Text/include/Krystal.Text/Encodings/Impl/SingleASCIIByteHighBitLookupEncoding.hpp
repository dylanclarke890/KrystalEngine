...
namespace Krys::Text::Impl
{
  template <typename TDerived,
            ...
            typename TCodeUnit = char, typename TCodePoint = UnicodeCodePoint>
  struct SingleASCIIByteHighBitLookupEncoding
  {
    ...
    constexpr static inline std::size_t MaxCodeUnits = 1;
                                    ...
                                    state &s) noexcept
    {
      ...
      {
        std::size_t lookupIndex = static_cast<std::size_t>(unit0) - 0x80u;

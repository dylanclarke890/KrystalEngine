...
namespace Krys::Text
{
  ...
  public:
    static constexpr utf8_stringview IANA = u8"ISO-8859-14";
    static constexpr EncodingInfo EncodingInformation = EncodingInfo {IANA, 28'604u};
  ...
  public:
    ISO_8859_14_Encoding() noexcept : SingleByteEncoding(EncodingInformation, LookupTable(LookupMapping))
    {
    }

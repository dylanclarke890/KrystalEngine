...
namespace Krys
{
  ...
  private:
    KRYS_NODISCARD static EncodingInfo GetEncodingInfo() noexcept
    {
      static EncodingInfo info {
        .Name = u8"ISO-8859-14",
        .Aliases = {u8"iso8859-14", u8"iso885914", u8"iso-8859-14"},
        .MIBenum = MIBenum {110u},
        .Win32CodePage = Win32CodePage {28'604u},
  ...
  public:
    static constexpr Mapping LookupMapping = {
      ...
      MapItem {0xA1u, Rune(0x1E02u)}, //	LATIN CAPITAL LETTER B WITH DOT ABOVE
      MapItem {0xA2u, Rune(0x1E03u)}, //	LATIN SMALL LETTER B WITH DOT ABOVE
      MapItem {0xA3u, Rune(0x00A3u)}, //	POUND SIGN
      MapItem {0xA4u, Rune(0x010Au)}, //	LATIN CAPITAL LETTER C WITH DOT ABOVE
      MapItem {0xA5u, Rune(0x010Bu)}, //	LATIN SMALL LETTER C WITH DOT ABOVE
      MapItem {0xA6u, Rune(0x1E0Au)}, //	LATIN CAPITAL LETTER D WITH DOT ABOVE
      MapItem {0xA7u, Rune(0x00A7u)}, //	SECTION SIGN
      MapItem {0xA8u, Rune(0x1E80u)}, //	LATIN CAPITAL LETTER W WITH GRAVE
      MapItem {0xA9u, Rune(0x00A9u)}, //	COPYRIGHT SIGN
      MapItem {0xAAu, Rune(0x1E82u)}, //	LATIN CAPITAL LETTER W WITH ACUTE
      MapItem {0xABu, Rune(0x1E0Bu)}, //	LATIN SMALL LETTER D WITH DOT ABOVE
      MapItem {0xACu, Rune(0x1EF2u)}, //	LATIN CAPITAL LETTER Y WITH GRAVE
      MapItem {0xADu, Rune(0x00ADu)}, //	SOFT HYPHEN
      MapItem {0xAEu, Rune(0x00AEu)}, //	REGISTERED SIGN
      MapItem {0xAFu, Rune(0x0178u)}, //	LATIN CAPITAL LETTER Y WITH DIAERESIS
      MapItem {0xB0u, Rune(0x1E1Eu)}, //	LATIN CAPITAL LETTER F WITH DOT ABOVE
      MapItem {0xB1u, Rune(0x1E1Fu)}, //	LATIN SMALL LETTER F WITH DOT ABOVE
      MapItem {0xB2u, Rune(0x0120u)}, //	LATIN CAPITAL LETTER G WITH DOT ABOVE
      MapItem {0xB3u, Rune(0x0121u)}, //	LATIN SMALL LETTER G WITH DOT ABOVE
      MapItem {0xB4u, Rune(0x1E40u)}, //	LATIN CAPITAL LETTER M WITH DOT ABOVE
      MapItem {0xB5u, Rune(0x1E41u)}, //	LATIN SMALL LETTER M WITH DOT ABOVE
      MapItem {0xB6u, Rune(0x00B6u)}, //	PILCROW SIGN
      MapItem {0xB7u, Rune(0x1E56u)}, //	LATIN CAPITAL LETTER P WITH DOT ABOVE
      MapItem {0xB8u, Rune(0x1E81u)}, //	LATIN SMALL LETTER W WITH GRAVE
      MapItem {0xB9u, Rune(0x1E57u)}, //	LATIN SMALL LETTER P WITH DOT ABOVE
      MapItem {0xBAu, Rune(0x1E83u)}, //	LATIN SMALL LETTER W WITH ACUTE
      MapItem {0xBBu, Rune(0x1E60u)}, //	LATIN CAPITAL LETTER S WITH DOT ABOVE
      MapItem {0xBCu, Rune(0x1EF3u)}, //	LATIN SMALL LETTER Y WITH GRAVE
      MapItem {0xBDu, Rune(0x1E84u)}, //	LATIN CAPITAL LETTER W WITH DIAERESIS
      MapItem {0xBEu, Rune(0x1E85u)}, //	LATIN SMALL LETTER W WITH DIAERESIS
      MapItem {0xBFu, Rune(0x1E61u)}, //	LATIN SMALL LETTER S WITH DOT ABOVE
      ...
      MapItem {0xD0u, Rune(0x0174u)}, //	LATIN CAPITAL LETTER W WITH CIRCUMFLEX
      ...
      MapItem {0xD7u, Rune(0x1E6Au)}, //	LATIN CAPITAL LETTER T WITH DOT ABOVE
      ...
      MapItem {0xDEu, Rune(0x0176u)}, //	LATIN CAPITAL LETTER Y WITH CIRCUMFLEX
      ...
      MapItem {0xF0u, Rune(0x0175u)}, //	LATIN SMALL LETTER W WITH CIRCUMFLEX
      ...
      MapItem {0xF7u, Rune(0x1E6Bu)}, //	LATIN SMALL LETTER T WITH DOT ABOVE
      ...
      MapItem {0xFEu, Rune(0x0177u)}, //	LATIN SMALL LETTER Y WITH CIRCUMFLEX
      MapItem {0xFFu, Rune(0x00FFu)}, //	LATIN SMALL LETTER Y WITH DIAERESIS
    };

  public:
    ISO_8859_14_Encoding() noexcept : SingleByteEncoding(GetEncodingInfo(), LookupTable(LookupMapping))
    {
    }

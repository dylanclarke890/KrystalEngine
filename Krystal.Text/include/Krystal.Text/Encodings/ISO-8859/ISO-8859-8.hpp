...
namespace Krys::Text
{
  ...
  public:
    static constexpr utf8_stringview IANA = u8"ISO-8859-8";
    static constexpr EncodingInfo EncodingInformation = EncodingInfo {IANA, 28'598u};
  ...
  public:
    ISO_8859_8_Encoding() noexcept : SingleByteEncoding(EncodingInformation, LookupTable(LookupMapping))
    {
    }

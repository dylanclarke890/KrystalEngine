...
namespace Krys::Text
{
  ...
  public:
    static constexpr utf8_stringview IANA = u8"ISO-8859-16";
    static constexpr EncodingInfo EncodingInformation = EncodingInfo {IANA, 28'606u};
    ...
    static constexpr Mapping LookupMapping = {
      ...
      MapItem {0xA2u, UnicodeCodepoint(0x0105u)}, //	LATIN SMALL LETTER A WITH OGONEK
      ...
      MapItem {0xAAu, UnicodeCodepoint(0x0218u)}, //	LATIN CAPITAL LETTER S WITH COMMA BELOW
      ...
      MapItem {0xAEu, UnicodeCodepoint(0x017Au)}, //	LATIN SMALL LETTER Z WITH ACUTE
      ...
      MapItem {0xB2u, UnicodeCodepoint(0x010Cu)}, //	LATIN CAPITAL LETTER C WITH CARON
      ...
      MapItem {0xB5u, UnicodeCodepoint(0x201Du)}, //	RIGHT DOUBLE QUOTATION MARK
      ...
      MapItem {0xB9u, UnicodeCodepoint(0x010Du)}, //	LATIN SMALL LETTER C WITH CARON
      MapItem {0xBAu, UnicodeCodepoint(0x0219u)}, //	LATIN SMALL LETTER S WITH COMMA BELOW
      ...
      MapItem {0xC5u, UnicodeCodepoint(0x0106u)}, //	LATIN CAPITAL LETTER C WITH ACUTE
      ...
      MapItem {0xD7u, UnicodeCodepoint(0x015Au)}, //	LATIN CAPITAL LETTER S WITH ACUTE
      MapItem {0xD8u, UnicodeCodepoint(0x0170u)}, //	LATIN CAPITAL LETTER U WITH DOUBLE ACUTE
      ...
      MapItem {0xDDu, UnicodeCodepoint(0x0118u)}, //	LATIN CAPITAL LETTER E WITH OGONEK
      MapItem {0xDEu, UnicodeCodepoint(0x021Au)}, //	LATIN CAPITAL LETTER T WITH COMMA BELOW
      ...
      MapItem {0xE5u, UnicodeCodepoint(0x0107u)}, //	LATIN SMALL LETTER C WITH ACUTE
      ...
      MapItem {0xF7u, UnicodeCodepoint(0x015Bu)}, //	LATIN SMALL LETTER S WITH ACUTE
      MapItem {0xF8u, UnicodeCodepoint(0x0171u)}, //	LATIN SMALL LETTER U WITH DOUBLE ACUTE
      ...
      MapItem {0xFDu, UnicodeCodepoint(0x0119u)}, //	LATIN SMALL LETTER E WITH OGONEK
      MapItem {0xFEu, UnicodeCodepoint(0x021Bu)}, //	LATIN SMALL LETTER T WITH COMMA BELOW
      MapItem {0xFFu, UnicodeCodepoint(0x00FFu)}, //	LATIN SMALL LETTER Y WITH DIAERESIS
    };

  public:
    ISO_8859_16_Encoding() noexcept : SingleByteEncoding(EncodingInformation, LookupTable(LookupMapping))
    {
    }

...
namespace Krys
{
  ...
  public:
    static constexpr utf8_stringview Name = u8"ISO-8859-16";
    static constexpr uint32 MIBenum = 112u;
    static constexpr uint32 WindowsCodePage = 28'606u;

...
namespace Krys::Text
{
  ...
  public:
    static constexpr utf8_stringview IANA = u8"ISO-8859-10";
    static constexpr EncodingInfo EncodingInformation = EncodingInfo {IANA, 28'600u};
  ...
  public:
    ISO_8859_10_Encoding() noexcept : SingleByteEncoding(EncodingInformation, LookupTable(LookupMapping))
    {
    }

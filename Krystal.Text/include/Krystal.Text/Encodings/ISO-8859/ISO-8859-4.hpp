...
namespace Krys
{
  ...
  public:
    static constexpr Mapping LookupMapping = {
      ...
      MapItem {0xA2u, UnicodeCodepoint(0x0138u)}, //	LATIN SMALL LETTER KRA
      MapItem {0xA3u, UnicodeCodepoint(0x0156u)}, //	LATIN CAPITAL LETTER R WITH CEDILLA
      ...
      MapItem {0xA6u, UnicodeCodepoint(0x013Bu)}, //	LATIN CAPITAL LETTER L WITH CEDILLA
      ...
      MapItem {0xAAu, UnicodeCodepoint(0x0112u)}, //	LATIN CAPITAL LETTER E WITH MACRON
      MapItem {0xABu, UnicodeCodepoint(0x0122u)}, //	LATIN CAPITAL LETTER G WITH CEDILLA
      MapItem {0xACu, UnicodeCodepoint(0x0166u)}, //	LATIN CAPITAL LETTER T WITH STROKE
      ...
      MapItem {0xB3u, UnicodeCodepoint(0x0157u)}, //	LATIN SMALL LETTER R WITH CEDILLA
      ...
      MapItem {0xB6u, UnicodeCodepoint(0x013Cu)}, //	LATIN SMALL LETTER L WITH CEDILLA
      ...
      MapItem {0xBAu, UnicodeCodepoint(0x0113u)}, //	LATIN SMALL LETTER E WITH MACRON
      MapItem {0xBBu, UnicodeCodepoint(0x0123u)}, //	LATIN SMALL LETTER G WITH CEDILLA
      MapItem {0xBCu, UnicodeCodepoint(0x0167u)}, //	LATIN SMALL LETTER T WITH STROKE
      MapItem {0xBDu, UnicodeCodepoint(0x014Au)}, //	LATIN CAPITAL LETTER ENG
      ...
      MapItem {0xCFu, UnicodeCodepoint(0x012Au)}, //	LATIN CAPITAL LETTER I WITH MACRON
      ...
      MapItem {0xD3u, UnicodeCodepoint(0x0136u)}, //	LATIN CAPITAL LETTER K WITH CEDILLA
      ...
      MapItem {0xDDu, UnicodeCodepoint(0x0168u)}, //	LATIN CAPITAL LETTER U WITH TILDE
      MapItem {0xDEu, UnicodeCodepoint(0x016Au)}, //	LATIN CAPITAL LETTER U WITH MACRON
      ...
      MapItem {0xEFu, UnicodeCodepoint(0x012Bu)}, //	LATIN SMALL LETTER I WITH MACRON
      ...
      MapItem {0xF3u, UnicodeCodepoint(0x0137u)}, //	LATIN SMALL LETTER K WITH CEDILLA
      ...
      MapItem {0xFDu, UnicodeCodepoint(0x0169u)}, //	LATIN SMALL LETTER U WITH TILDE
      MapItem {0xFEu, UnicodeCodepoint(0x016Bu)}, //	LATIN SMALL LETTER U WITH MACRON

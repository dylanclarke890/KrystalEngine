...
namespace Krys::Text
{
  ...
  public:
    static constexpr utf8_stringview IANA = u8"ISO-8859-2";
    static constexpr EncodingInfo EncodingInformation = EncodingInfo {IANA, 28'592u};
  ...
  public:
    ISO_8859_2_Encoding() noexcept : SingleByteEncoding(EncodingInformation, LookupTable(LookupMapping))
    {
    }

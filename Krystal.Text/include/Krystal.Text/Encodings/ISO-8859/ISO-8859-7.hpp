...
namespace Krys::Text
{
  ...
  public:
    static constexpr utf8_stringview IANA = u8"ISO-8859-7";
    static constexpr EncodingInfo EncodingInformation = EncodingInfo {IANA, 28'597u};
    ...
    static constexpr Mapping LookupMapping = {
      ...
      MapItem {0xA1u, UnicodeCodepoint(0x2018u)}, //	LEFT SINGLE QUOTATION MARK
      MapItem {0xA2u, UnicodeCodepoint(0x2019u)}, //	RIGHT SINGLE QUOTATION MARK
      MapItem {0xA3u, UnicodeCodepoint(0x00A3u)}, //	POUND SIGN
      MapItem {0xA4u, UnicodeCodepoint(0x20ACu)}, //	EURO SIGN
      MapItem {0xA5u, UnicodeCodepoint(0x20AFu)}, //	DRACHMA SIGN
      ...
      MapItem {0xAAu, UnicodeCodepoint(0x037Au)}, //	GREEK YPOGEGRAMMENI
      ...
      MapItem {0xB5u, UnicodeCodepoint(0x0385u)}, //	GREEK DIALYTIKA TONOS
      MapItem {0xB6u, UnicodeCodepoint(0x0386u)}, //	GREEK CAPITAL LETTER ALPHA WITH TONOS
  ...
  public:
    ISO_8859_7_Encoding() noexcept : SingleByteEncoding(EncodingInformation, LookupTable(LookupMapping))
    {
    }

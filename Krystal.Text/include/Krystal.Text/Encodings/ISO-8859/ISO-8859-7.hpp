...
namespace Krys::Text
{
  ...
  public:
    static constexpr utf8_stringview Name = u8"ISO-8859-7";
    static constexpr uint32 MIBenum = 10u;
    static constexpr uint32 WindowsCodePage = 28'597u;

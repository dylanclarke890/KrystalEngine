...
namespace Krys::Text
{
  ...
  public:
    ...
    static constexpr EncodingInfo EncodingInformation = EncodingInfo {IANA, 28'591u};
  ...
  public:
    ISO_8859_1_Encoding() noexcept : SingleByteEncoding(EncodingInformation, LookupTable(LookupMapping))
    {
    }

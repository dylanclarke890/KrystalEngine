...
namespace Krys::Text
{
  ...
  public:
    static constexpr utf8_stringview Name = u8"ISO-8859-9";
    static constexpr uint32 MIBenum = 12u;
    static constexpr uint32 WindowsCodePage = 28'599u;

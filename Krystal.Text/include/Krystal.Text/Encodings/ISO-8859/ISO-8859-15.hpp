...
namespace Krys::Text
{
  ...
  public:
    static constexpr utf8_stringview Name = u8"ISO-8859-15";
    static constexpr uint32 MIBenum = 111u;
    static constexpr uint32 WindowsCodePage = 28'605u;

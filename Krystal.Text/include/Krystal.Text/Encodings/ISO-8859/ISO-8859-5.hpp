...
namespace Krys::Text
{
  ...
  public:
    static constexpr utf8_stringview IANA = u8"ISO-8859-5";
    static constexpr EncodingInfo EncodingInformation = EncodingInfo {IANA, 28'595u};
  ...
  public:
    ISO_8859_5_Encoding() noexcept : SingleByteEncoding(EncodingInformation, LookupTable(LookupMapping))
    {
    }

...
#include "Krystal.Text/Encodings/EncodingTables/Windows874.hpp"
...
namespace Krys::Text
{
  ...
  class basic_windows_874
      : public SingleASCIIByteHighBitLookupEncoding<
          basic_windows_874<TCodeUnit, TCodePoint>, &EncodingTable::Windows874IndexToCodePoint,
          &EncodingTable::Windows874CodePointToIndex, TCodeUnit, TCodePoint>
  {
  public:
    ...
    constexpr static inline ::Krys::Array<::Krys::Text::ASCIILiteral, 6> Aliases = {
      "dos-874"_s, "iso-8859-11"_s, "iso8859-11"_s, "iso885911"_s, "tis-620"_s, "windows-874"_s};
  };

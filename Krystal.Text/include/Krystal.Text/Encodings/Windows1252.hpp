...
#include "Krystal.Text/Encodings/EncodingTables/Windows1252.hpp"
...
namespace Krys::Text
{
  ...
  class basic_windows_1252
      : public SingleASCIIByteHighBitLookupEncoding<
          basic_windows_1252<TCodeUnit, TCodePoint>, &EncodingTable::Windows1252IndexToCodePoint,
          &EncodingTable::Windows1252CodePointToIndex, TCodeUnit, TCodePoint>
  {
  public:

...
namespace Krys
{
  ...
  public:
    static constexpr Mapping LookupMapping = {
      ...
      MapItem {0xA4u, UnicodeCodepoint(0x2553u)}, //	BOX DRAWINGS DOWN DOUBLE AND RIGHT SINGLE
      MapItem {0xA5u, UnicodeCodepoint(0x2554u)}, //	BOX DRAWINGS DOUBLE DOWN AND RIGHT
      MapItem {0xA6u, UnicodeCodepoint(0x2555u)}, //	BOX DRAWINGS DOWN SINGLE AND LEFT DOUBLE
      MapItem {0xA7u, UnicodeCodepoint(0x2556u)}, //	BOX DRAWINGS DOWN DOUBLE AND LEFT SINGLE
      ...
      MapItem {0xADu, UnicodeCodepoint(0x255Cu)}, //	BOX DRAWINGS UP DOUBLE AND LEFT SINGLE
      ...
      MapItem {0xB4u, UnicodeCodepoint(0x2562u)}, //	BOX DRAWINGS VERTICAL DOUBLE AND LEFT SINGLE
      MapItem {0xB5u, UnicodeCodepoint(0x2563u)}, //	BOX DRAWINGS DOUBLE VERTICAL AND LEFT
      MapItem {0xB6u, UnicodeCodepoint(0x2564u)}, //	BOX DRAWINGS DOWN SINGLE AND HORIZONTAL DOUBLE
      MapItem {0xB7u, UnicodeCodepoint(0x2565u)}, //	BOX DRAWINGS DOWN DOUBLE AND HORIZONTAL SINGLE
      ...
      MapItem {0xBDu, UnicodeCodepoint(0x256Bu)}, //	BOX DRAWINGS VERTICAL DOUBLE AND HORIZONTAL SINGLE

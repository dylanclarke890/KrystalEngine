...
namespace Krys::Text
{
  ...
  class basic_petscii_unshifted
      : public SingleByteLookupEncoding<
          basic_petscii_unshifted<TCodeUnit, TCodePoint>, &EncodingTable::PETSCIIUnshiftedIndexToCodePoint,
          &EncodingTable::PETSCIIUnshiftedCodePointToIndex, TCodeUnit, TCodePoint>
  {
  public:

...
namespace Krys::Text
{
  ...
  class basic_gbk : public Basic_GBK_GB18030<basic_gbk<TCodeUnit, TCodePoint>, TCodeUnit, TCodePoint, true>
  {
  public:
    constexpr static inline ASCIILiteral Name = {"GBK"_s};
    constexpr static inline Array<ASCIILiteral, 9> Aliases = {"chinese"_s, "csgb2312"_s,  "csiso58gb231280"_s,
                                                              "gb2312"_s,  "gb_2312"_s,   "gb_2312-80"_s,
                                                              "gbk"_s,     "iso-ir-58"_s, "x-gbk"_s};
  };

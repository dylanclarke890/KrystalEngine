...
namespace Krys::Text
{
  ...
  class Windows1256Encoding : public Encoding
  {
  public:
    static constexpr utf8_stringview IANA = u8"windows-1256";
    static constexpr EncodingInfo EncodingInformation = EncodingInfo {IANA, 1'256u};

  public:
    constexpr Windows1256Encoding() noexcept : Encoding(EncodingInformation)
    {
    }

    constexpr virtual ~Windows1256Encoding() noexcept = default;

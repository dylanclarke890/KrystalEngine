...
namespace Krys
{
  ...
  private:
    KRYS_NODISCARD static EncodingInfo GetEncodingInfo() noexcept
    {
      static EncodingInfo info {
        .Name = u8"windows-1255",
        .Aliases = {u8"windows-1255"},
        .MIBenum = MIBenum {2'255u},
        .Win32CodePage = Win32CodePage {1'255u},
  ...
  public:
    static constexpr Mapping LookupMapping = {
      ...
      MapItem {0x98u, Rune(0x02DCu)}, // SMALL TILDE
      ...
      MapItem {0xA1u, Rune(0x00A1u)}, // INVERTED EXCLAMATION MARK
      MapItem {0xA2u, Rune(0x00A2u)}, // CENT SIGN
      MapItem {0xA3u, Rune(0x00A3u)}, // POUND SIGN
      MapItem {0xA4u, Rune(0x20AAu)}, // NEW SHEQEL SIGN
      ...
      MapItem {0xBFu, Rune(0x00BFu)}, // INVERTED QUESTION MARK
      MapItem {0xC0u, Rune(0x05B0u)}, // HEBREW POINT SHEVA
      MapItem {0xC1u, Rune(0x05B1u)}, // HEBREW POINT HATAF SEGOL
      MapItem {0xC2u, Rune(0x05B2u)}, // HEBREW POINT HATAF PATAH
      MapItem {0xC3u, Rune(0x05B3u)}, // HEBREW POINT HATAF QAMATS
      MapItem {0xC4u, Rune(0x05B4u)}, // HEBREW POINT HIRIQ
      MapItem {0xC5u, Rune(0x05B5u)}, // HEBREW POINT TSERE
      MapItem {0xC6u, Rune(0x05B6u)}, // HEBREW POINT SEGOL
      MapItem {0xC7u, Rune(0x05B7u)}, // HEBREW POINT PATAH
      MapItem {0xC8u, Rune(0x05B8u)}, // HEBREW POINT QAMATS
      MapItem {0xC9u, Rune(0x05B9u)}, // HEBREW POINT HOLAM
      MapItem {0xCBu, Rune(0x05BBu)}, // HEBREW POINT QUBUTS
      MapItem {0xCCu, Rune(0x05BCu)}, // HEBREW POINT DAGESH OR MAPIQ
      MapItem {0xCDu, Rune(0x05BDu)}, // HEBREW POINT METEG
      MapItem {0xCEu, Rune(0x05BEu)}, // HEBREW PUNCTUATION MAQAF
      MapItem {0xCFu, Rune(0x05BFu)}, // HEBREW POINT RAFE
      MapItem {0xD0u, Rune(0x05C0u)}, // HEBREW PUNCTUATION PASEQ
      MapItem {0xD1u, Rune(0x05C1u)}, // HEBREW POINT SHIN DOT
      MapItem {0xD2u, Rune(0x05C2u)}, // HEBREW POINT SIN DOT
      MapItem {0xD3u, Rune(0x05C3u)}, // HEBREW PUNCTUATION SOF PASUQ
      MapItem {0xD4u, Rune(0x05F0u)}, // HEBREW LIGATURE YIDDISH DOUBLE VAV
      MapItem {0xD5u, Rune(0x05F1u)}, // HEBREW LIGATURE YIDDISH VAV YOD
      MapItem {0xD6u, Rune(0x05F2u)}, // HEBREW LIGATURE YIDDISH DOUBLE YOD
      MapItem {0xD7u, Rune(0x05F3u)}, // HEBREW PUNCTUATION GERESH
      MapItem {0xD8u, Rune(0x05F4u)}, // HEBREW PUNCTUATION GERSHAYIM
  ...
  public:
    Windows1255Encoding() noexcept : SingleByteEncoding(GetEncodingInfo(), LookupTable(LookupMapping))
    {
    }

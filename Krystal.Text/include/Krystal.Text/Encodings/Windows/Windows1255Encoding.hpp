...
namespace Krys::Text
{
  ...
  class Windows1255Encoding : public Encoding
  {
  public:
    static constexpr utf8_stringview IANA = u8"windows-1255";
    static constexpr EncodingInfo EncodingInformation = EncodingInfo {IANA, 1'255u};

  public:
    constexpr Windows1255Encoding() noexcept : Encoding(EncodingInformation)
    {
    }

    constexpr virtual ~Windows1255Encoding() noexcept = default;

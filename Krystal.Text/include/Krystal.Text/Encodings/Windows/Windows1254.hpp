...
namespace Krys::Text
{
  ...
  public:
    static constexpr utf8_stringview Name = u8"windows-1254";
    static constexpr uint32 MIBenum = 2'254u;
    static constexpr uint32 WindowsCodePage = 1'254u;
    ...
    static constexpr Mapping LookupMapping = {
      ...
      MapItem {0xD0u, UnicodeCodepoint(0x011Eu)}, // LATIN CAPITAL LETTER G WITH BREVE
      ...
      MapItem {0xDDu, UnicodeCodepoint(0x0130u)}, // LATIN CAPITAL LETTER I WITH DOT ABOVE
      MapItem {0xDEu, UnicodeCodepoint(0x015Eu)}, // LATIN CAPITAL LETTER S WITH CEDILLA
      ...
      MapItem {0xF0u, UnicodeCodepoint(0x011Fu)}, // LATIN SMALL LETTER G WITH BREVE
      ...
      MapItem {0xFDu, UnicodeCodepoint(0x0131u)}, // LATIN SMALL LETTER DOTLESS I
      MapItem {0xFEu, UnicodeCodepoint(0x015Fu)}, // LATIN SMALL LETTER S WITH CEDILLA
      MapItem {0xFFu, UnicodeCodepoint(0x00FFu)}, // LATIN SMALL LETTER Y WITH DIAERESIS
    };

  public:
    Windows1254Encoding() noexcept : SingleByteEncoding({ Name, MIBenum, WindowsCodePage }, LookupTable(LookupMapping))
    {
    }

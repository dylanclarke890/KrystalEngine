...
namespace Krys
{
  class Windows1254Encoding : public SingleByteEncoding
  {
  private:
    KRYS_NODISCARD static EncodingInfo GetEncodingInfo() noexcept
    {
      static EncodingInfo info {
        .Name = u8"windows-1254",
        .Aliases = {u8"windows-1254"},
        .MIBenum = MIBenum {2'254u},
        .Win32CodePage = Win32CodePage {1'254u},
  ...
  public:
    static constexpr Mapping LookupMapping = {
      ...
      MapItem {0x9Fu, Rune(0x0178u)}, // LATIN CAPITAL LETTER Y WITH DIAERESIS
      ...
      MapItem {0xAAu, Rune(0x00AAu)}, // FEMININE ORDINAL INDICATOR
      ...
      MapItem {0xBAu, Rune(0x00BAu)}, // MASCULINE ORDINAL INDICATOR
      ...
      MapItem {0xD0u, Rune(0x011Eu)}, // LATIN CAPITAL LETTER G WITH BREVE
      ...
      MapItem {0xDDu, Rune(0x0130u)}, // LATIN CAPITAL LETTER I WITH DOT ABOVE
      MapItem {0xDEu, Rune(0x015Eu)}, // LATIN CAPITAL LETTER S WITH CEDILLA
      ...
      MapItem {0xF0u, Rune(0x011Fu)}, // LATIN SMALL LETTER G WITH BREVE
      ...
      MapItem {0xFDu, Rune(0x0131u)}, // LATIN SMALL LETTER DOTLESS I
      MapItem {0xFEu, Rune(0x015Fu)}, // LATIN SMALL LETTER S WITH CEDILLA
      MapItem {0xFFu, Rune(0x00FFu)}, // LATIN SMALL LETTER Y WITH DIAERESIS
    };

  public:
    Windows1254Encoding() noexcept : SingleByteEncoding(GetEncodingInfo(), LookupTable(LookupMapping))
    {
    }

    ~Windows1254Encoding() noexcept override = default;
  };
}
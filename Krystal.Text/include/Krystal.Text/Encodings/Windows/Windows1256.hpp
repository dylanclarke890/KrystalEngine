...
namespace Krys
{
  ...
  public:
    static constexpr Mapping LookupMapping = {
      ...
      MapItem {0x81u, Rune(0x067Eu)}, // ARABIC LETTER PEH
      MapItem {0x82u, Rune(0x201Au)}, // SINGLE LOW-9 QUOTATION MARK
      MapItem {0x83u, Rune(0x0192u)}, // LATIN SMALL LETTER F WITH HOOK
      ...
      MapItem {0x88u, Rune(0x02C6u)}, // MODIFIER LETTER CIRCUMFLEX ACCENT
      MapItem {0x89u, Rune(0x2030u)}, // PER MILLE SIGN
      MapItem {0x8Au, Rune(0x0679u)}, // ARABIC LETTER TTEH
      MapItem {0x8Bu, Rune(0x2039u)}, // SINGLE LEFT-POINTING ANGLE QUOTATION MARK
      MapItem {0x8Cu, Rune(0x0152u)}, // LATIN CAPITAL LIGATURE OE
      MapItem {0x8Du, Rune(0x0686u)}, // ARABIC LETTER TCHEH
      MapItem {0x8Eu, Rune(0x0698u)}, // ARABIC LETTER JEH
      MapItem {0x8Fu, Rune(0x0688u)}, // ARABIC LETTER DDAL
      MapItem {0x90u, Rune(0x06AFu)}, // ARABIC LETTER GAF
      ...
      MapItem {0x98u, Rune(0x06A9u)}, // ARABIC LETTER KEHEH
      MapItem {0x99u, Rune(0x2122u)}, // TRADE MARK SIGN
      MapItem {0x9Au, Rune(0x0691u)}, // ARABIC LETTER RREH
      MapItem {0x9Bu, Rune(0x203Au)}, // SINGLE RIGHT-POINTING ANGLE QUOTATION MARK
      MapItem {0x9Cu, Rune(0x0153u)}, // LATIN SMALL LIGATURE OE
      MapItem {0x9Du, Rune(0x200Cu)}, // ZERO WIDTH NON-JOINER
      MapItem {0x9Eu, Rune(0x200Du)}, // ZERO WIDTH JOINER
      MapItem {0x9Fu, Rune(0x06BAu)}, // ARABIC LETTER NOON GHUNNA
      MapItem {0xA0u, Rune(0x00A0u)}, // NO-BREAK SPACE
      MapItem {0xA1u, Rune(0x060Cu)}, // ARABIC COMMA
      ...
      MapItem {0xAAu, Rune(0x06BEu)}, // ARABIC LETTER HEH DOACHASHMEE
      ...
      MapItem {0xBAu, Rune(0x061Bu)}, // ARABIC SEMICOLON
      ...
      MapItem {0xC0u, Rune(0x06C1u)}, // ARABIC LETTER HEH GOAL
      ...
      MapItem {0xD8u, Rune(0x0637u)}, // ARABIC LETTER TAH
      MapItem {0xD9u, Rune(0x0638u)}, // ARABIC LETTER ZAH
      MapItem {0xDAu, Rune(0x0639u)}, // ARABIC LETTER AIN
      MapItem {0xDBu, Rune(0x063Au)}, // ARABIC LETTER GHAIN
      MapItem {0xDCu, Rune(0x0640u)}, // ARABIC TATWEEL
      MapItem {0xDDu, Rune(0x0641u)}, // ARABIC LETTER FEH
      MapItem {0xDEu, Rune(0x0642u)}, // ARABIC LETTER QAF
      MapItem {0xDFu, Rune(0x0643u)}, // ARABIC LETTER KAF
      MapItem {0xE0u, Rune(0x00E0u)}, // LATIN SMALL LETTER A WITH GRAVE
      MapItem {0xE1u, Rune(0x0644u)}, // ARABIC LETTER LAM
      MapItem {0xE2u, Rune(0x00E2u)}, // LATIN SMALL LETTER A WITH CIRCUMFLEX
      MapItem {0xE3u, Rune(0x0645u)}, // ARABIC LETTER MEEM
      MapItem {0xE4u, Rune(0x0646u)}, // ARABIC LETTER NOON
      MapItem {0xE5u, Rune(0x0647u)}, // ARABIC LETTER HEH
      MapItem {0xE6u, Rune(0x0648u)}, // ARABIC LETTER WAW
      ...
      MapItem {0xECu, Rune(0x0649u)}, // ARABIC LETTER ALEF MAKSURA
      MapItem {0xEDu, Rune(0x064Au)}, // ARABIC LETTER YEH
      ...
      MapItem {0xF0u, Rune(0x064Bu)}, // ARABIC FATHATAN
      MapItem {0xF1u, Rune(0x064Cu)}, // ARABIC DAMMATAN
      MapItem {0xF2u, Rune(0x064Du)}, // ARABIC KASRATAN
      MapItem {0xF3u, Rune(0x064Eu)}, // ARABIC FATHA
      MapItem {0xF4u, Rune(0x00F4u)}, // LATIN SMALL LETTER O WITH CIRCUMFLEX
      MapItem {0xF5u, Rune(0x064Fu)}, // ARABIC DAMMA
      MapItem {0xF6u, Rune(0x0650u)}, // ARABIC KASRA
      MapItem {0xF7u, Rune(0x00F7u)}, // DIVISION SIGN
      MapItem {0xF8u, Rune(0x0651u)}, // ARABIC SHADDA
      MapItem {0xF9u, Rune(0x00F9u)}, // LATIN SMALL LETTER U WITH GRAVE
      MapItem {0xFAu, Rune(0x0652u)}, // ARABIC SUKUN
      ...
      MapItem {0xFFu, Rune(0x06D2u)}, // ARABIC LETTER YEH BARREE
    };

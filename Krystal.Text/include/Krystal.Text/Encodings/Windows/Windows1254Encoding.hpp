...
namespace Krys::Text
{
  ...
  public:
    static constexpr utf8_stringview IANA = u8"windows-1254";
    static constexpr EncodingInfo EncodingInformation = EncodingInfo {IANA, 1'254u};
  ...
  public:
    Windows1254Encoding() noexcept : SingleByteEncoding(EncodingInformation, LookupTable(LookupMapping))
    {
    }

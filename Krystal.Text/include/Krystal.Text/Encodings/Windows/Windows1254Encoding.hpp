...
namespace Krys::Text
{
  class Windows1254Encoding : public Encoding
  {
  public:
  ...
  public:
    constexpr Windows1254Encoding() noexcept : Encoding(EncodingInformation)
    {
    }

    constexpr virtual ~Windows1254Encoding() noexcept = default;

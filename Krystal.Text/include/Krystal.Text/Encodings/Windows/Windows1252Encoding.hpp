...
namespace Krys::Text
{
  ...
  class Windows1252Encoding : public Encoding
  {
  public:
    static constexpr utf8_stringview IANA = u8"windows-1252";
    static constexpr EncodingInfo EncodingInformation = EncodingInfo {IANA, 1'252u};

  public:
    constexpr Windows1252Encoding() noexcept : Encoding(EncodingInformation)
    {
    }

    constexpr virtual ~Windows1252Encoding() noexcept = default;

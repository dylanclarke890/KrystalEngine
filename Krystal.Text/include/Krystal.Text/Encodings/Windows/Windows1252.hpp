...
namespace Krys
{
  ...
  public:
    static constexpr Mapping LookupMapping = {
      ...
      MapItem {0xD0u, Rune(0x00D0u)}, // LATIN CAPITAL LETTER ETH
      ...
      MapItem {0xDEu, Rune(0x00DEu)}, // LATIN CAPITAL LETTER THORN
      ...
      MapItem {0xF0u, Rune(0x00F0u)}, // LATIN SMALL LETTER ETH
      ...
      MapItem {0xFEu, Rune(0x00FEu)}, // LATIN SMALL LETTER THORN
  ...
  public:
    ...
    ~Windows1252Encoding() noexcept override = default;
  };
}
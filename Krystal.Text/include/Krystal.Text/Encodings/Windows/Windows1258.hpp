...
namespace Krys
{
  ...
  private:
    KRYS_NODISCARD static EncodingInfo GetEncodingInfo() noexcept
    {
      static EncodingInfo info {
        .Name = u8"windows-1258",
        .Aliases = {u8"windows-1258", u8"dos-874", u8"iso-8859-11", u8"iso8859-11", u8"iso885911",
                    u8"tis-620"},
        .MIBenum = MIBenum {2'258u},
        .Win32CodePage = Win32CodePage {1'258u},
  ...
  public:
    static constexpr Mapping LookupMapping = {
      ...
      MapItem {0xCCu, Rune(0x0300u)}, // COMBINING GRAVE ACCENT
      ...
      MapItem {0xD2u, Rune(0x0309u)}, // COMBINING HOOK ABOVE
      ...
      MapItem {0xD5u, Rune(0x01A0u)}, // LATIN CAPITAL LETTER O WITH HORN
      ...
      MapItem {0xDDu, Rune(0x01AFu)}, // LATIN CAPITAL LETTER U WITH HORN
      MapItem {0xDEu, Rune(0x0303u)}, // COMBINING TILDE
      ...
      MapItem {0xECu, Rune(0x0301u)}, // COMBINING ACUTE ACCENT
      ...
      MapItem {0xF2u, Rune(0x0323u)}, // COMBINING DOT BELOW
      ...
      MapItem {0xF5u, Rune(0x01A1u)}, // LATIN SMALL LETTER O WITH HORN
      ...
      MapItem {0xFDu, Rune(0x01B0u)}, // LATIN SMALL LETTER U WITH HORN
      MapItem {0xFEu, Rune(0x20ABu)}, // DONG SIGN
      MapItem {0xFFu, Rune(0x00FFu)}, // LATIN SMALL LETTER Y WITH DIAERESIS
    };

  public:
    Windows1258Encoding() noexcept : SingleByteEncoding(GetEncodingInfo(), LookupTable(LookupMapping))
    {
    }

...
#pragma region uint8
    ...
    KRYS_NODISCARD constexpr static uint16 Encode(uint8 x, uint8 y) noexcept
    {
      uint16 a(x);
      uint16 b(y);
    ...
    KRYS_NODISCARD constexpr static uint32 Encode(uint8 x, uint8 y, uint8 z) noexcept
    {
      uint32 a(x);
      uint32 b(y);
      uint32 c(z);
    ...
    KRYS_NODISCARD constexpr static uint32 Encode(uint8 x, uint8 y, uint8 z, uint8 w) noexcept
    {
      uint32 a(x);
      uint32 b(y);
      uint32 c(z);
    ...
    KRYS_NODISCARD constexpr static uint16 Encode(const Vector2<uint8> &v) noexcept
    {
      return Encode(v.x, v.y);
    }

    KRYS_NODISCARD constexpr static uint32 Encode(const Vector3<uint8> &v) noexcept
    {
      return Encode(v.x, v.y, v.z);
    }

    KRYS_NODISCARD constexpr static uint32 Encode(const Vector4<uint8> &v) noexcept
    {
      return Encode(v.x, v.y, v.z, v.w);
    }

    KRYS_NODISCARD constexpr static Vector2<uint8> Decode(uint16 x)
    {
      uint16 a(x);
      uint16 b(x >> 1u);
...
#pragma region int8
    ...
    KRYS_NODISCARD constexpr static int16 Encode(int8 x, int8 y) noexcept
    {
    ...
    KRYS_NODISCARD constexpr static int32 Encode(int8 x, int8 y, int8 z)
    {
      uint8 a = std::bit_cast<uint8>(x);
      uint8 b = std::bit_cast<uint8>(y);
    ...
    KRYS_NODISCARD constexpr static int32 Encode(int8 x, int8 y, int8 z, int8 w)
    {
      uint8 a = std::bit_cast<uint8>(x);
      uint8 b = std::bit_cast<uint8>(y);
      uint8 c = std::bit_cast<uint8>(z);
    ...
    KRYS_NODISCARD constexpr static int16 Encode(const Vector2<int8> &v) noexcept
    {
      return Encode(v.x, v.y);
    }

    KRYS_NODISCARD constexpr static int32 Encode(const Vector3<int8> &v) noexcept
    {
      return Encode(v.x, v.y, v.z);
    }

    KRYS_NODISCARD constexpr static int32 Encode(const Vector4<int8> &v) noexcept
    {
      return Encode(v.x, v.y, v.z, v.w);
    }
...
#pragma region uint16
    ...
    KRYS_NODISCARD constexpr static uint32 Encode(uint16 x, uint16 y) noexcept
    {
      uint32 a(x);
      uint32 b(y);
    ...
    KRYS_NODISCARD constexpr static uint64 Encode(uint16 x, uint16 y, uint16 z) noexcept
    {
      uint64 a(x);
      uint64 b(y);
      uint64 c(z);
    ...
    KRYS_NODISCARD constexpr static uint64 Encode(uint16 x, uint16 y, uint16 z, uint16 w) noexcept
    {
      uint64 a(x);
      uint64 b(y);
      uint64 c(z);
    ...
    KRYS_NODISCARD constexpr static uint32 Encode(const Vector2<uint16> &v) noexcept
    {
      return Encode(v.x, v.y);
    }

    KRYS_NODISCARD constexpr static uint64 Encode(const Vector3<uint16> &v) noexcept
    {
      return Encode(v.x, v.y, v.z);
    }

    KRYS_NODISCARD constexpr static uint64 Encode(const Vector4<uint16> &v) noexcept
    {
      return Encode(v.x, v.y, v.z, v.w);
    }

    KRYS_NODISCARD constexpr static Vector2<uint16> Decode(uint32 x)
    {
      uint32 a(x);
      uint32 b(x >> 1u);
...
#pragma region int16
    ...
    KRYS_NODISCARD constexpr static int32 Encode(int16 x, int16 y) noexcept
    {
    ...
    KRYS_NODISCARD constexpr static int64 Encode(int16 x, int16 y, int16 z) noexcept
    {
      uint16 a = std::bit_cast<uint16>(x);
      uint16 b = std::bit_cast<uint16>(y);
    ...
    KRYS_NODISCARD constexpr static int64 Encode(int16 x, int16 y, int16 z, int16 w) noexcept
    {
      uint16 a = std::bit_cast<uint16>(x);
      uint16 b = std::bit_cast<uint16>(y);
      uint16 c = std::bit_cast<uint16>(z);
    ...
    KRYS_NODISCARD constexpr static int32 Encode(const Vector2<int16> &v) noexcept
    {
      return Encode(v.x, v.y);
    }

    KRYS_NODISCARD constexpr static int64 Encode(const Vector3<int16> &v) noexcept
    {
      return Encode(v.x, v.y, v.z);
    }

    KRYS_NODISCARD constexpr static int64 Encode(const Vector4<int16> &v) noexcept
    {
      return Encode(v.x, v.y, v.z, v.w);
    }
...
#pragma region uint32
    ...
    KRYS_NODISCARD constexpr static uint64 Encode(uint32 x, uint32 y) noexcept
    {
      uint64 a(x);
      uint64 b(y);
    ...
    KRYS_NODISCARD constexpr static uint64 Encode(uint32 x, uint32 y, uint32 z) noexcept
    {
      uint64 a(x);
      uint64 b(y);
      uint64 c(z);
    ...
    KRYS_NODISCARD constexpr static uint64 Encode(const Vector2<uint32> &v) noexcept
    {
      return Encode(v.x, v.y);
    }

    KRYS_NODISCARD constexpr static uint64 Encode(const Vector3<uint32> &v) noexcept
    {
      return Encode(v.x, v.y, v.z);
    }

    KRYS_NODISCARD constexpr static Vector2<uint32> Decode(uint64 x)
    {
      uint64 a(x);
      uint64 b(x >> 1u);
...
#pragma region int32
    ...
    KRYS_NODISCARD constexpr static int64 Encode(int32 x, int32 y) noexcept
    {
    ...
    KRYS_NODISCARD constexpr static int64 Encode(int32 x, int32 y, int32 z) noexcept
    {
      uint32 a = std::bit_cast<uint32>(x);
      uint32 b = std::bit_cast<uint32>(y);
    ...
    KRYS_NODISCARD constexpr static int64 Encode(const Vector2<int32> &v) noexcept
    {
      return Encode(v.x, v.y);
    }

    KRYS_NODISCARD constexpr static int64 Encode(const Vector3<int32> &v) noexcept
    {
      return Encode(v.x, v.y, v.z);
    }

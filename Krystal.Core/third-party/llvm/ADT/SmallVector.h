...
namespace llvm
{
  ...
  using EnableIfConvertibleToInputIterator =
    std::enable_if_t<std::is_convertible<typename std::iterator_traits<Iterator>::iterator_category,
  ...
  protected:
    ...
    {
      krys_assert(N <= capacity()); // implies no overflow in assignment
  ...
  {
    alignas(
      SmallVectorBase<SmallVectorSizeType<T>>) char Base[sizeof(SmallVectorBase<SmallVectorSizeType<T>>)];
  ...
  protected:
    ...
    {
      krys_assert(isSafeToReferenceAfterResize(Elt, NewSize)
  ...
  public:
    ...
    {
      krys_assert(this->size() >= N && "Cannot increase size with truncate");
    ...
    {
      krys_assert(this->size() >= NumItems);
    ...
    iterator erase(const_iterator CI)
    {
      ...
      krys_assert(this->isReferenceToStorage(CI) && "Iterator to erase is out of bounds.");
    ...
    iterator erase(const_iterator CS, const_iterator CE)
    {
      ...
      krys_assert(this->isRangeInStorage(S, E) && "Range to erase is out of bounds.");
  ...
  private:
    ...
    iterator insert_one_impl(iterator I, ArgType &&Elt)
    {
      ...
      krys_assert(this->isReferenceToStorage(I) && "Insertion iterator is out of bounds.");
  ...
  struct CalculateSmallVectorDefaultInlinedElements
  {
    ...
    static_assert(sizeof(T) <= 256, "You are trying to use a default number of inlined elements for "
  ...
  using ValueTypeFromRangeType = std::remove_const_t<detail::ValueOfRange<RangeType>>;

...
///
  ...
  // two preprocessor definitions to gate LLVM_ABI macro definitions.
    ...
    #elif __has_attribute(visibility)
      #if defined(__ELF__) || defined(__MINGW32__) || defined(_AIX) || defined(__MVS__) || defined(__CYGWIN__)
...
// within "krys_assert"), this attribute can be used to suppress such warnings.
//
...
#if __has_attribute(weak) && !defined(__MINGW32__) && !defined(__CYGWIN__) && !defined(_WIN32)
...
#if defined(__cplusplus) && __cplusplus > 201'402L && LLVM_HAS_CPP_ATTRIBUTE(fallthrough)
...
#if LLVM_HAS_CPP_ATTRIBUTE(nodiscard) >= 201'907L
...
#if !defined(_MSC_VER) || _MSC_VER >= 1'943 || defined(__clang__)
...
/// Adjust type of bit-field in debug info.
  ...
  #define LLVM_MOVABLE_POLYMORPHIC_TYPE                                                                      \
    [[clang::ptrauth_vtable_pointer(default_key, no_address_discrimination, default_extra_discrimination)]]
#else
  #define LLVM_MOVABLE_POLYMORPHIC_TYPE
#endif

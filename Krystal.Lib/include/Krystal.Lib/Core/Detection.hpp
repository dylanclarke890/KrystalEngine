...
/// @brief Check if a particular platform is being used. KRYS_PLATFORM(KNOWN) is true if we explicitly support
/// a target platform.
#define KRYS_PLATFORM(PLATFORM) (defined KRYS_PLATFORM_##PLATFORM && KRYS_PLATFORM_##PLATFORM)
...
// KRYS_PLATFORM(WINDOWS) - Microsoft Windows (any version)
#if defined(_WIN32) || defined(_WIN64)
  #define KRYS_PLATFORM_WINDOWS 1
  #define KRYS_PLATFORM_KNOWN 1

  #if defined(_WIN64)
    #define KRYS_PLATFORM_WIN64
  #else
    #define KRYS_PLATFORM_WIN32
  #endif
#endif

// KRYS_PLATFORM(APPLE) - Apple platforms (iOS, macOS)
#if defined(__APPLE__) || defined(__MACH__)
  #define KRYS_PLATFORM_APPLE 1
  #define KRYS_PLATFORM_KNOWN 1
...
// KRYS_PLATFORM(ANDROID) - Android OS
#if defined(__ANDROID__)
  #define KRYS_PLATFORM_ANDROID 1
  #define KRYS_PLATFORM_KNOWN 1
#endif

// KRYS_PLATFORM(LINUX) - Linux OS
#if defined(__linux__) && !!KRYS_PLATFORM(ANDROID)
  #define KRYS_PLATFORM_LINUX 1
  #define KRYS_PLATFORM_KNOWN 1
#endif

#if !KRYS_PLATFORM(KNOWN)
  #define KRYS_PLATFORM_UNKNOWN 1
#endif
